# -*- coding: utf-8 -*-
"""7Análise de popularidade .ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1aihwt8au8_uHfVAl_5x2H0PQug1xfLuE
...
for fb in dic.keys():
    ...
    for node in no:
        #A popularidade de cada marca é calculada pela simples soma das propriedades 'Quantidade_de_Sentimento':
